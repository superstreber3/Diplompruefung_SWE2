...
public class Database {
    ...
    private Database() {
        ...
        List<Apartment> apartments1 = List.of(
                ...
                new Apartment(Map.of("Bathroom", 1, "Livingroom", 1, "Bedroom", 1)),
                new Apartment(Map.of("Bathroom", 1, "Livingroom", 1, "Bedroom", 2)),
                new Apartment(Map.of("Bathroom", 2, "Livingroom", 1, "Bedroom", 4))
        );
        ...
        List<Apartment> apartments2 = List.of(
                new Apartment(Map.of("Bathroom", 2, "Livingroom", 1, "Bedroom", 2)),
                new Apartment(Map.of("Bathroom", 1, "Livingroom", 1, "Bedroom", 1)),
                new Apartment(Map.of("Bathroom", 1, "Livingroom", 1, "Bedroom", 1)),
                new Apartment(Map.of("Bathroom", 2, "Livingroom", 1, "Bedroom", 3))
        );
